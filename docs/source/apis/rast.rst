...
the :func:`gsplat2d.rasterize_gaussians` function first sorts each gaussian such that all gaussians within the bounds of a tile are grouped and sorted by increasing depth :math:`z`,
...
The python bindings support conventional 3-channel RGB rasterization as well as N-dimensional rasterization with :func:`gsplat2d.rasterize_gaussians`.
